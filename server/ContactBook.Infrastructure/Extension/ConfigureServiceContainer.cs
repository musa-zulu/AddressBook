using AutoMapper;
using AddressBook.Infrastructure.Mapping;
    ...
    public static class ConfigureServiceContainer
    {
             ...
             IConfiguration configuration, IConfigurationRoot configRoot)
        {
            serviceCollection.AddDbContext<ApplicationDbContext>(options =>
                   options.UseSqlServer(configuration.GetConnectionString("AddressBookConn") ?? configRoot["ConnectionStrings:AddressBookConn"])
                );
        }
